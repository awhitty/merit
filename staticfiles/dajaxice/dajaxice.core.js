...
var Dajaxice = {
    ...
    add_rsvp: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app.merit.add_rsvp', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    delete_rsvp: function(callback_function, argv, custom_settings){
        return Dajaxice.call('events.delete_rsvp', 'POST', callback_function, argv, custom_settings);
    },

    add_rsvp: function(callback_function, argv, custom_settings){
        return Dajaxice.call('events.add_rsvp', 'POST', callback_function, argv, custom_settings);
    }
