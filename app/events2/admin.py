...
class EventAdmin(admin.ModelAdmin):
  ...
  inlines               = [OccurrenceInline, AttachmentInlines]
...
class OccurrenceAdmin(admin.ModelAdmin):
  ...
  readonly_fields = ('start_time', 'end_time', 'tags')
  date_hierarchy = 'start_time'
  fields         = ('start_date','event', 'alt_start_time', 'alt_end_time', 'start_time', 'end_time', 'tags')
  inlines        = [RSVPInline]
