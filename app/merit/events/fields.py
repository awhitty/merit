...
class TimeField(DateUtilMixin, forms.TimeField):
    """Time field that accepts natural-language input.
    """
...
def get_formfield_for(field, **kwargs):
    ...
    if isinstance(field, models.DateTimeField):
        ...
        kwargs.update({'form_class': TimeField})
        return field.formfield(**kwargs)
